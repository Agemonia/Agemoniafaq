...
**Are pets considered items for the purpose of not being able to pick them up while hindered or non-transferable with an ability like telekinesis?** Yes, pets are items therefore a Hero is not able to pick them up or transfer them with telekinesis while hindered. Confirm?

**Can pet figures be picked up while hindered?** Yes, while being hindered restricts picking up items, it does not restrict picking up a pet figure. Confirm?
...
<p><b>Does the Lumin Demon Special Movement rules override the normal Enemy movement rules for always moving as far toward an area it can attack from? Ex: A Lumin Demon is blocked from entering an area with a Cultist due to maximum capacity and terrain. Does the Demon try to move around the long way (as per normal rules) or would the Demon always move closer to the nearest Cultist, sometime resulting in no movement?</b> Yes, the Lumin Demon Special Movement rules override the normal Enemy movement rules. The Demons will always move as far as they can towards the nearest Cultist (which may result in no movement at all in some cases).</p>
</details>
<br>
